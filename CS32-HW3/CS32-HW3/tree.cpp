...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
	...
	if (a1[0] == a2[0])
		result = countIncludes(a1 + 1, n1 - 1, a2, n2) + countIncludes(a1 + 1, n1 - 1, a2 + 1, n2 - 1);
	else
...
void order(double a[], int n)
{
	...
	divide(a, n, a[0], firstNotGreater, firstLess);	//divide array a to to part with divider a[0]
