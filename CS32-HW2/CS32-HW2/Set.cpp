...
Set::Set()
{
	//since the set list is empty in the begining, 
...
{
	Node *killme = nullptr; //use to find the location of the node and check if the value is exist.
	Node *p = m_dummy.next;
	...
	if (killme == nullptr)
		return false;		//we didn't find the node that contain the value we want to erase
	else
	{
...
Set &Set::operator=(const Set& rhs)
{
	...
	{
		//delete all the old nodes first
